...
if __name__ == "__main__":
    ...
    delegate_parser.add_argument('delegator_bip44_account', type=valid_account, help='BIP44 account of delegator (e.g. 42)')
    delegate_parser.add_argument('delegator_address', type=valid_address("Delegator"), help='Address of delegator')
    delegate_parser.add_argument('delegate', type=valid_address("Delegate"), help='Address of delegate')
    delegate_parser.add_argument('--mina_url', help='Mina rosetta interface url (default http://localhost:3087)')
    delegate_parser.add_argument('--network', help='Network override')
    delegate_parser.add_argument('--fee', help='Fee override')
    delegate_parser.add_argument('--nonce', help='Nonce override')
    delegate_parser.add_argument('--valid_until', type=valid_valid_until, help='Valid until')
    delegate_parser.add_argument('--memo', type=valid_memo, help='Transaction memo (publicly visible)')
    delegate_parser.add_argument('--offline', default=False, action="store_true", help='Offline mode')
